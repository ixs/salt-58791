...
echo "distro>=1.2" >> requirements/base.txt

sed -i '/pycryptodomex/d' requirements/crypto.txt
echo "M2Crypto>=0.33.0" >> requirements/crypto.txt
...
%changelog
* Tue Oct 20 2020 SaltStack Packaging Team <packaging@saltstack.com> - 3002-1
- Update to feature release 3002-1  for Python 3
